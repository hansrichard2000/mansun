    ...
    <div class="container-fluid">
        <form method="POST" action="{{route('admin.student.update', $student->student_id)}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="name" placeholder="Input nama mahasiswa" value="{{$student->name}}" required>
            </div>
            <div class="form-group">
                <label for="nim">NIM : </label>
                <input type="text" class="form-control" id="nim" name="nim" placeholder="Input nomor induk mahasiswa" value="{{$student->nim}}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" placeholder="Input email mahasiswa"value="{{$student->email}}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="batch" name="batch" placeholder="Input tahun angkatan mahasiswa"value="{{$student->batch}}" required>
            </div>
            <div class="form-group">
