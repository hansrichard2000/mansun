    ...
    <div class="container-fluid">
        <form method="POST" action="{{route('admin.lecturer.update', $lecturer->lecturer_id)}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="name" placeholder="Input nama dosen" value="{{$lecturer->name}}" required>
            </div>
            <div class="form-group">
                <label for="nip">NIP : </label>
                <input type="text" class="form-control" id="nip" name="nip" placeholder="Input nomor induk pengajar" value="{{$lecturer->nip}}" required>
            </div>
            <div class="form-group">
                <label for="nim">NIDN : </label>
                <input type="text" class="form-control" id="nidn" name="nidn" placeholder="Input nomor induk dosen nasional" value="{{$lecturer->nidn}}" required>
            </div>
            <div class="form-group">
                <label for="gender">Jenis Kelamin : </label><br>
                @if($lecturer->gender == "L")
                    <input type="radio" id="L" name="gender" value="L" checked required>
                ...
                @else
                    ...
                    <label for="L">Laki-laki</label><br>
                    <input type="radio" id="P" name="gender" value="P" checked required>
                    <label for="P">Perempuan</label><br>
                @endif
            </div>
            <div class="form-group">
                <label for="email">Email : </label>
                <input type="email" class="form-control" id="email" name="email" placeholder="Input email dosen"value="{{$lecturer->email}}" required>
            </div>
            <div class="form-group">
